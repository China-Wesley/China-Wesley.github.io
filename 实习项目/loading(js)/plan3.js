...
// __inline('../../common-util/mw_config_i18n.js')

window.run = {
    loadingPic_3_gif: './plan3.gif',
    loadingPic_3_bottom: './plan3.png',
    starLight: './starLight.png',
    starDark: './starDark.png',
  
    setHtml: function(name, icon, starNum, gameType, installNum) {
      let html = '';
      // if (window.MW_CONFIG) {
      //   try {
      //     name = window.MW_CONFIG_I18N.getAppName()
      //     icon = window.MW_CONFIG_I18N.getAppIcon()
      //   } catch (e) {
      //     console.log(e)
      //   }
      // }
    ...
    addLoading: function(name, icon, starNum, gameType, installNum){
        let self = this;
        self.addWrap();
        document.querySelector('#loader-placeholder').innerHTML = self.setHtml(name, icon, starNum, gameType, installNum);
        self.addStyle()
          console.log('loading')
   },
    addStyle: function(){
    ...
    init: function(name, icon, starNum, gameType, installNum) {
      var self = this
      self.addLoading(name, icon, starNum, gameType, installNum);
      return true;
      // if (window.MW_CONFIG && window.MW_CONFIG.channel === 'dsp') {
