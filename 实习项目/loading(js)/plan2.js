...
window.run = {
    loadingPic_2: './plan2.gif',
    starLight: './starLight.png',
    starDark: './starDark.png',
  
    setHtml: function(name, icon, starNum, gameDiscribe) {
    ...
    addLoading: function(name, icon, starNum, gameDiscribe){
        let self = this;
        self.addWrap();
        document.querySelector('#loader-placeholder').innerHTML = self.setHtml(name, icon, starNum, gameDiscribe);
        self.addStyle()
          console.log('loading')
    },
    addStyle: function(){
    ...
    init: function(name, icon, starNum, gameDiscribe) {
      var self = this
      self.addLoading(name, icon, starNum, gameDiscribe);
      return true;
